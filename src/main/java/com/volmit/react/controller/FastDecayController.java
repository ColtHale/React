    ...
    public GList<ItemStack> getDrops(Block b)
    {
        ...
        switch (XMaterial.matchXMaterial(b.getType()))
        {
            case ACACIA_LEAVES:
                if (M.r(0.05))
                {
                    System.out.println("Acacia leaf");
                    assert XMaterial.ACACIA_SAPLING.parseMaterial() != null;
                    drops.add(new ItemStack(XMaterial.ACACIA_SAPLING.parseMaterial(), 1));
                    System.out.println("Acacia leaf2");
                }
                break;
            case BIRCH_LEAVES:
                if (M.r(0.05))
                {
                    ...
                    assert XMaterial.BIRCH_SAPLING.parseMaterial() != null;
                    drops.add(new ItemStack(XMaterial.BIRCH_SAPLING.parseMaterial(), 1));
                    System.out.println("Birch2");
                }
                break;
            case DARK_OAK_LEAVES:
                if (M.r(0.005))
                {
                    ...
                    System.out.println("d oak 1");
                }

                if (M.r(0.05))
                {
                    assert XMaterial.DARK_OAK_SAPLING.parseMaterial() != null;
                    drops.add(new ItemStack(XMaterial.DARK_OAK_SAPLING.parseMaterial(), 1));
                    System.out.println("d oak 2");
                }
                break;
            case OAK_LEAVES: // oak
                if (M.r(0.005))
                {
                    drops.add(new ItemStack(Material.APPLE));
                    System.out.println("oak 1");
                }

                if (M.r(0.05))
                {
                    assert XMaterial.OAK_SAPLING.parseMaterial() != null;
                    drops.add(new ItemStack(XMaterial.OAK_SAPLING.parseMaterial(), 1));
                    System.out.println("oak 2");
                }
                break;
            case JUNGLE_LEAVES:
                if (M.r(0.025))
                {
                    System.out.println("jungle 1");
                    assert XMaterial.JUNGLE_SAPLING.parseMaterial() != null;
                    drops.add(new ItemStack(XMaterial.JUNGLE_SAPLING.parseMaterial(), 1));
                    System.out.println("jungle 2");
                }
                break;
            case SPRUCE_LEAVES:// spruce
                if (M.r(0.05))
                {
                    assert XMaterial.SPRUCE_SAPLING.parseMaterial() != null;
                    drops.add(new ItemStack(XMaterial.SPRUCE_SAPLING.parseMaterial(), 1));
                    System.out.println("spruce 1");
                }
                break;
        }
